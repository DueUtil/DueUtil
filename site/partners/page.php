...
$page = new StandardLayout($sidebar,$partner_page, $title = "Partner - $name", "DueUtil partnered $partner_details->type - $name");
$page->body_append(new StaticContent("<style>#content-title {display:none}</style>"));
$page->show();
